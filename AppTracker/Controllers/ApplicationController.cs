...
namespace AppTracker.Controllers
{
    public class ApplicationController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApplicationID,Position,DateApplied,AppliedVia,AppSubmitted,ResSubmitted,CLSubmitted,CompanyID")] Application application)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApplicationID,Position,DateApplied,AppliedVia,AppSubmitted,ResSubmitted,CLSubmitted,CompanyID")] Application application)
        {
            if (ModelState.IsValid)
            {
